...
/// <summary>
/// A register for CloudEvent metadata and handlers
/// </summary>
/// <remarks>
...
internal sealed class Register(IServiceCollection services, RegisterOptions options)
{
    ...
    public void RegisterEventsAndHandlers()
    {
        foreach (var type in options.Assemblies.SelectMany(a => a.DefinedTypes))
        {
            ...
            foreach (var handlerInterface in handlerInterfaces)
            {
                ...
                var handlerDelegate = (HandleCloudEventDelegate)typeof(Register)
